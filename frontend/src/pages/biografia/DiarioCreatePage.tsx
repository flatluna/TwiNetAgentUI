...
const DiarioCreatePage: React.FC = () => {
    ...
    const handleGooglePlaceSelected = (placeData: {
        ...
        console.log('🗺️ Google Place selected in DiarioCreatePage:', placeData);
    ...
    const guardarEntrada = async () => {
        ...
        try {
            ...
            const diaryData = {
                ...
                participantes: entrada.participantes || '', // ✅ Agregar participantes
                ...
                ...(entrada.camposExtra?.pais && { pais: entrada.camposExtra.pais }),
                ...(entrada.camposExtra?.ciudad && { ciudad: entrada.camposExtra.ciudad }),
                ...(entrada.camposExtra?.estado && { estado: entrada.camposExtra.estado }),
                ...(entrada.camposExtra?.codigoPostal && { codigoPostal: entrada.camposExtra.codigoPostal }),
                ...(entrada.camposExtra?.direccion && { direccion: entrada.camposExtra.direccion }),
                ...(entrada.camposExtra?.distrito && { distrito: entrada.camposExtra.distrito }),
                ...(entrada.camposExtra?.telefono && { telefono: entrada.camposExtra.telefono }),
                ...(entrada.camposExtra?.website && { website: entrada.camposExtra.website }),
                ...(entrada.camposExtra?.latitud && { latitud: Number(entrada.camposExtra.latitud) }),
                ...(entrada.camposExtra?.longitud && { longitud: Number(entrada.camposExtra.longitud) }),
            ...
            // Debug logging
            console.log('📔 Creando nueva entrada de diario - Twin ID:', twinId);
            ...
            console.log('🌍 Campos de ubicación enviados:', {
                ...
                latitud: entrada.camposExtra?.latitud,
                longitud: entrada.camposExtra?.longitud
            });
            console.log('📔 Archivos seleccionados:', Object.keys(archivosSeleccionados));
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div className="space-y-2">
                            <label className="flex items-center space-x-2 text-sm font-medium text-gray-700">
                                ...
                                <span>Dirección del lugar (opcional)</span>
                            </label>
